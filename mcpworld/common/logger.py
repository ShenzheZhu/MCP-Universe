...
LOGLEVEL = "INFO"
LOGGER_NAME = "MCPWorld"
TRACE_LOGGER_NAME = "MCPWorld.trace"
...
LOG_CONFIG = {
    ...
    "loggers": {
        "MCPWorld": {"handlers": ["MCPWorld"], "level": LOGLEVEL, "propagate": False},
        "MCPWorld.trace": {"handlers": ["MCPWorld_trace"], "level": LOGLEVEL, "propagate": False},
