...
@eval_func(name="json")
def json_decode(x: Any, *args, **kwargs) -> Any:
    """JSON decoding."""
    ...
    if isinstance(x, (list, tuple)):
        return [json_decode(y, *args, **kwargs) for y in x]
    raise NotImplementedError(f"`json_decode` doesn't support type {type(x)}")


@eval_func(name="get")
def get(x: Any, key: str, *args, **kwargs) -> Any:
...
@compare_func(name="=")
def equal(a: Any, b: Any, *args, **kwargs) -> (bool, str):
    """Equal"""
    if a == b:
        return True, ""
...
@compare_func(name="<")
def less_than(a: Any, b: Any, *args, **kwargs) -> (bool, str):
    """Less than"""
    if a < b:
        return True, ""
...
@compare_func(name="<=")
def less_equal(a: Any, b: Any, *args, **kwargs) -> (bool, str):
...
@compare_func(name=">")
def greater_than(a: Any, b: Any, *args, **kwargs) -> (bool, str):
    """Greater than"""
    if a > b:
        return True, ""
...
@compare_func(name=">=")
def greater_equal(a: Any, b: Any, *args, **kwargs) -> (bool, str):
...
def is_in(a: Any, b: List, *args, **kwargs) -> (bool, str):
    """In a list"""
...
def contain(a: List | str, b: Any, *args, **kwargs) -> (bool, str):
    """Contains"""
